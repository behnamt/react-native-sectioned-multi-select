...
class SectionedMultiSelect extends PureComponent {
  ...
  static propTypes = {
    ...
    selectedTextPostfix: PropTypes.string,
  ...
  _getSelectLabel = () => {
    ...
    return `${selectedTextPrefix} ${selectedItems.length} ${selectedTextPostfix}`
  }
      ...
      return (
        ...
        <View
          style={[{
            ...
            borderRadius: 20,
            borderWidth: 1,
          }, this.styles.singleChipContainer]}
          key={item[uniqueKey]}
        >
...

        {
          selectedItems.length > 0 && !single && showChips ?
            ...
            >
              ...
              <ScrollView horizontal={true} style={this.styles.chipWrapper}>
